...
<h2 class="text-center pt-5 pb-3">Login</h2>
    ...
    <form class="container mt-5 mb-5" action="login.php" method="post">
    <label for="">Introdueix el nom d'usuari</label>
    <input class="form-control" type="text" name="usuari" id="">
    <label for="">Introdueix la teva contrasenya</label>
    <input class="form-control" type="password" name="contrasenya" id="">
